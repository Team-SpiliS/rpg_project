...
public class PlayerCombat : MonoBehaviour, IDamageBlocker
{
    ...
    {
        if (input.Controls.Player.Block.IsPressed())
        {
            if (!IsBlocking)
            {
                IsBlocking = true;
    ...
    private void HandleMeleeInput()
    {
        ...
        if (input.Controls.Player.Attack.WasPressedThisFrame() && Time.time >= nextMeleeTime)
        {
    ...
    private void HandleMagicInput()
    {
        ...
        if (input.Controls.Player.Magic.WasPressedThisFrame() && Time.time >= nextMagicTime)
        {
